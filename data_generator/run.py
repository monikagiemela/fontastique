...
from data_generator.data_generator import FakeTextDataGenerator
from data_generator.string_generator import (create_strings_from_dict,
                                   create_strings_from_file,
                                   create_strings_from_wikipedia,
                                   create_strings_randomly)
from data_generator.utils import load_dict, load_fonts
...
def main():
    ...
    for font in os.listdir(path):
        ...
        if args.name_format == 2:
            ...
            with open(
                os.path.join(fontname, "labels.txt"), "w", encoding="utf8"
            ) as f:
